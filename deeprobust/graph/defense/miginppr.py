...
class MIGIN(nn.Module):
    ...
    def forward(self, x, att_walk_adj):
        ...
        att_walk_adj = att_walk_adj.coalesce()

        edge_index = att_walk_adj.indices()
        edge_weight = att_walk_adj.values()
